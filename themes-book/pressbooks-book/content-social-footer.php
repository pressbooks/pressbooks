<!-- Share buttons -->
	<div class="share-wrap-single">
		<ul class="share share-single">
			<li class="email"><a href="mailto:?subject=<?php echo rawurlencode( __('I wanted to share this post with you from', 'pressbooks') ); ?> <?php bloginfo('name'); ?>&body=<?php the_title(); ?> - <?php the_permalink(); ?>" title="<?php _e('Email to a friend', 'pressbooks'); ?>" target="_blank"><?php _e('Share via Email', 'pressbooks'); ?></a>
			</li>
