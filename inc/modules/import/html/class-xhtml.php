...
class Xhtml extends Import {
	...
	function kneadAndInsert( $html, $post_type, $chapter_parent, $domain, $post_status ) {
		...
		$author = $meta['authors'] ?? $this->getAuthors( $html );
	 ...
	 * @return array $meta
	 */
	protected function scrapeAndKneadMeta( \DOMDocument $doc ): array {
		$meta = [];
	 ...
	 * @return \DOMDocument
	 */
	protected function scrapeAndKneadImages( \DOMDocument $doc, string $domain ): \DOMDocument {
