...
function add_contributor_image_size() {
	add_theme_support( 'post-thumbnails' );
	add_image_size( 'contributor-picture', 300, 300, true );
}

function merge_contributor_size( $sizes ) {
	return array_merge( $sizes, array(
		'contributor-picture' => __('Contributor picture'),
	) );
}
