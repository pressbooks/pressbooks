...
class Docx extends Import {
	 ...
	 * @var type 
	 */
	protected $schema = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument';
	...
	function import( array $current_import ) {
		...
		$dom_doc = $proc->transformToXML( $xml );
		
		//$html = $this->tidy($dom_doc);
		echo "<pre>";
		print_r( $dom_doc );
		echo "</pre>";
		die();
