...
class MetadataTest extends \WP_UnitTestCase
{
     ...
     * @group metadata
     */
    public function test_add_candela_citations()
    {
     ...
     * @group metadata
     */
    public function test_get_in_catalog_option()
    {
     ...
     * @group metadata
     */
    public function test_download_thema_subjects()
    {
     ...
     * @group metadata
     */
    public function test_register_contributor_meta_enqueue_script()
    {
