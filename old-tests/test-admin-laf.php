...
class Admin_LafTest extends \WP_UnitTestCase
{
     ...
     * @group branding
     */
    public function test_add_footer_link()
    {
        ob_start();
     ...
     * @group branding
     */
    public function test_replace_book_admin_menu_AND_init_css_js()
    {
        global $menu, $submenu;
     ...
     * @group branding
     */
    public function test_fix_root_admin_menu()
    {
     ...
     * @group branding
     */
    public function test_add_pb_cloner_page()
    {
        $user_id = $this->factory()->user->create();
        $user = get_userdata($user_id);
        $user->add_role('subscriber');
     ...
     * @group branding
     */
    public function test_cloning_page_is_not_shown_if_new_books_are_not_allowed()
    {
     ...
     * @test
     */
    public function cloning_stats_submenu_is_added()
    {
        $user_id = $this->factory()->user->create();
        $user = get_userdata($user_id);
        $user->add_role('subscriber');
     ...
     * @group branding
     */
    public function test_custom_screen_options()
    {
     ...
     * @group branding
     */
    public function test_replace_menu_bar_my_sites()
    {
        $this->_book();
        $user_id = $this->factory()->user->create([ 'role' => 'administrator' ]);
        wp_set_current_user($user_id);
     ...
     * @group branding
     */
    public function test_display_export()
    {
     ...
     * @group branding
     */
    public function test_sites_to_books()
    {
     ...
     * @group branding
     */
    public function test_edit_screen_navigation()
    {
        $this->_book();
     ...
     * @group branding
     */
    public function test_user_contact_fields()
    {
     ...
     * @group branding
     */
    public function test_modify_user_fields()
    {
        $methods = [
            'aim' => '',
            'yim' => '',
     ...
     * @group branding
     */
    public function test_sanitize_user_profile()
    {
     ...
     * @group branding
     */
    public function test_institution_fields_hooks()
    {
        global $post, $pagenow;
        $user_id = $this->factory()->user->create([ 'role' => 'administrator' ]);
        wp_set_current_user($user_id);
