...
<div class="wrap">
    ...
    <p>{{ __( 'You can select multiple formats below. Pressbooks keeps the last three exports of each file format. You can pin specific files to make sure they don\'t get deleted', 'pressbooks') }}</p>
