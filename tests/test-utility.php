...
class UtilityTest extends \WP_UnitTestCase {
	...
	public function test_do_shortcode_by_tags() {
		...
		$expected = '<img src="http://localhost:3000/latex?latex=e%5E%7B%5Ci+%5Cpi%7D+%2B+1+%3D+0&fg=000000" alt="e^{\i \pi} + 1 = 0" title="e^{\i \pi} + 1 = 0" class="latex mathjax" />[embed]https://image.png[/embed]';
		...
		$expected = '<img src="http://localhost:3000/latex?latex=e%5E%7B%5Ci+%5Cpi%7D+%2B+1+%3D+0&fg=000000" alt="e^{\i \pi} + 1 = 0" title="e^{\i \pi} + 1 = 0" class="latex mathjax" />';
