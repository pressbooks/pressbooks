...
function add_meta_boxes() {
	...
	x_add_metadata_group( 'general-book-information', 'metadata', [
		'label' => __( 'General Book Information', 'pressbooks' ),
		'priority' => 'high',
	] );

	x_add_metadata_field( 'pb_title', 'metadata', [
		'group' => 'general-book-information',
		'label' => 'Title',
	] );

	x_add_metadata_field( 'pb_short_title', 'metadata', [
		'group' => 'general-book-information',
	...
	x_add_metadata_field( 'pb_subtitle', 'metadata', [
		'group' => 'general-book-information',
		'label' => __( 'Subtitle', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_author', 'metadata', [
		'group' => 'general-book-information',
		'label' => __( 'Author', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_author_file_as', 'metadata', [
		'group' => 'general-book-information',
	...
	x_add_metadata_field( 'pb_contributing_authors', 'metadata', [
		'group' => 'general-book-information',
	...
	x_add_metadata_field( 'pb_publisher', 'metadata', [
		'group' => 'general-book-information',
		'label' => __( 'Publisher', 'pressbooks' ),
		'description' => __( 'This text appears on the title page of your book.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_publisher_city', 'metadata', [
		'group' => 'general-book-information',
		'label' => __( 'Publisher City', 'pressbooks' ),
		'description' => __( 'This text appears on the title page of your book.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_publication_date', 'metadata', [
	...
	x_add_metadata_field( 'pb_onsale_date', 'metadata', [
		'field_type' => 'datepicker',
		'group' => 'general-book-information',
	...
	x_add_metadata_field( 'pb_ebook_isbn', 'metadata', [
		'group' => 'general-book-information',
	...
	x_add_metadata_field( 'pb_print_isbn', 'metadata', [
		'group' => 'general-book-information',
	...
	x_add_metadata_field( 'pb_language', 'metadata', [
		'group' => 'general-book-information',
		'field_type' => 'select',
	...
	x_add_metadata_group( 'copyright', 'metadata', [
		'label' => __( 'Copyright', 'pressbooks' ),
		'priority' => 'low',
	] );

	x_add_metadata_field( 'pb_copyright_year', 'metadata', [
		'group' => 'copyright',
		'label' => __( 'Copyright Year', 'pressbooks' ),
		'description' => __( 'Year that the book is/was published.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_copyright_holder', 'metadata', [
		'group' => 'copyright',
		'label' => __( 'Copyright Holder', 'pressbooks' ),
		'description' => __( 'Name of the copyright holder.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_book_license', 'metadata', [
		'group' => 'copyright',
		'field_type' => 'select',
		'values' => [
			'' => '--Select--',
			'public-domain' => __( 'No Rights Reserved (Public Domain)', 'pressbooks' ),
			'cc-by' => __( 'CC BY (Attribution)', 'pressbooks' ),
			'cc-by-sa' => __( 'CC BY-SA (Attribution ShareAlike)', 'pressbooks' ),
			'cc-by-nd' => __( 'CC BY-ND (Attribution NoDerivatives)', 'pressbooks' ),
			'cc-by-nc' => __( 'CC BY-NC (Attribution NonCommercial)', 'pressbooks' ),
			'cc-by-nc-sa' => __( 'CC BY-NC-SA (Attribution NonCommercial ShareAlike)', 'pressbooks' ),
			'cc-by-nc-nd' => __( 'CC BY-NC-ND (Attribution NonCommercial NoDerivatives)', 'pressbooks' ),
			'all-rights-reserved' => __( 'All Rights Reserved', 'pressbooks' ),
		],
	...
	x_add_metadata_field( 'pb_custom_copyright', 'metadata', [
		'field_type' => 'wysiwyg',
		'group' => 'copyright',
	...
	x_add_metadata_group( 'about-the-book', 'metadata', [
		'label' => 'About the Book',
		'priority' => 'low',
	] );

	x_add_metadata_field( 'pb_about_140', 'metadata', [
	...
	x_add_metadata_field( 'pb_about_50', 'metadata', [
		'field_type' => 'textarea',
		'group' => 'about-the-book',
	...
	x_add_metadata_field( 'pb_about_unlimited', 'metadata', [
		'field_type' => 'wysiwyg',
		'group' => 'about-the-book',
	...
	x_add_metadata_group( 'additional-catalogue-information', 'metadata', [
		'label' => __( 'Additional Catalog Information', 'pressbooks' ),
		'priority' => 'low',
	] );

	x_add_metadata_field( 'pb_series_title', 'metadata', [
	...
	x_add_metadata_field( 'pb_series_number', 'metadata', [
		'group' => 'additional-catalogue-information',
		'label' => __( 'Series Number', 'pressbooks' ),
		'description' => __( 'Add if your book is part of a series. This is not used by Pressbooks.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_editor', 'metadata', [
		'group' => 'additional-catalogue-information',
		'label' => __( 'Editor', 'pressbooks' ),
		'description' => __( 'This is not used by Pressbooks.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_translator', 'metadata', [
		'group' => 'additional-catalogue-information',
		'label' => __( 'Translator', 'pressbooks' ),
		'description' => __( 'This is not used by Pressbooks.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_keywords_tags', 'metadata', [
		'group' => 'additional-catalogue-information',
	...
	x_add_metadata_field( 'pb_hashtag', 'metadata', [
		'group' => 'additional-catalogue-information',
	...
	x_add_metadata_field( 'pb_list_price_print', 'metadata', [
		'group' => 'additional-catalogue-information',
		'label' => __( 'List Price (Print)', 'pressbooks' ),
		'description' => __( 'This is not used by Pressbooks.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_list_price_pdf', 'metadata', [
		'group' => 'additional-catalogue-information',
		'label' => __( 'List Price (PDF)', 'pressbooks' ),
		'description' => __( 'This is not used by Pressbooks.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_list_price_epub', 'metadata', [
		'group' => 'additional-catalogue-information',
		'label' => __( 'List Price (ebook)', 'pressbooks' ),
		'description' => __( 'This is not used by Pressbooks.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_list_price_web', 'metadata', [
		'group' => 'additional-catalogue-information',
		'label' => __( 'List Price (Web)', 'pressbooks' ),
		'description' => __( 'This is not used by Pressbooks.', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_audience', 'metadata', [
		'group' => 'additional-catalogue-information',
		'field_type' => 'select',
		'values' => [
	...
	x_add_metadata_field( 'pb_bisac_regional_theme', 'metadata', [
		'group' => 'additional-catalogue-information',
	...
	if ( 'pressbooks-root' !== $root_theme->Template ) {
		x_add_metadata_field( 'pb_catalogue_order', 'metadata', [
			'group' => 'additional-catalogue-information',
	...
	x_add_metadata_group( 'chapter-parent', 'chapter', [
	...
	x_add_metadata_group( 'export', [ 'chapter', 'front-matter', 'back-matter' ], [
		'label' => __( 'Export Settings', 'pressbooks' ),
		'context' => 'side',
		'priority' => 'high',
	] );

	x_add_metadata_field( 'pb_export', [ 'chapter', 'front-matter', 'back-matter' ], [
		'group' => 'export',
		'field_type' => 'checkbox',
		'label' => __( 'Include in exports', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_show_title', [ 'chapter', 'front-matter', 'back-matter' ], [
		'group' => 'export',
		'field_type' => 'checkbox',
		'label' => __( 'Show title in exports', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_ebook_start', [ 'chapter', 'front-matter', 'back-matter' ], [
		'group' => 'export',
		'field_type' => 'checkbox',
	...
	x_add_metadata_group( 'part-metadata-text', 'part', [
		'label' => __( 'Part Text', 'pressbooks' ),
	] );

	x_add_metadata_field( 'pb_part_content', 'part', [
		'field_type' => 'wysiwyg',
	...
	x_add_metadata_group( 'part-metadata-visibility', 'part', [
		'label' => __( 'Part Visibility', 'pressbooks' ),
		'context' => 'side',
		'priority' => 'low',
	] );

	x_add_metadata_field( 'pb_part_invisible', 'part', [
		'field_type' => 'checkbox',
...
function add_bisac_subjects_field() {
	x_add_metadata_field( 'pb_bisac_subject', 'metadata', [
		'group' => 'additional-catalogue-information',
