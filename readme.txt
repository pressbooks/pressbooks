...
* See: https://github.com/pressbooks/pressbooks/releases/tag/5.9.5
* Full release history available at: https://github.com/pressbooks/pressbooks/releases

== Upgrade Notice ==
= 5.9.5 =

* Pressbooks 5.9.5 requires PHP >= 7.1.
* Pressbooks 5.9.5 requires [WordPress 5.2.4](https://wordpress.org/news/2019/10/wordpress-5-2-4-security-release/)
* Pressbooks 5.9.5 requires [McLuhan >= 2.8.12](https://github.com/pressbooks/pressbooks-book/)
