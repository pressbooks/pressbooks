System.register(["./lit-element-legacy-DWFBGLyg.js"],function(t,e){"use strict";var o,i,s,n;return{setters:[t=>{o=t.r,i=t.i,s=t.x,n=t.E}],execute:function(){window.customElements.define("pressbooks-multiselect",class extends o{static get styles(){return i`
      :host {
...
/**
       ...
       */
function*(t,e){if(void 0!==t){let o=0;for(const i of t)yield e(i,o++)}}(this.groups,(e,o)=>s`${e?s`<ul
                  class="combo-group"
                  role="group"
