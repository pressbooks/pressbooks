...
add_action( 'plugins_loaded', [ '\Pressbooks\EventStreams', 'init' ] );
...
if ( $is_book ) {
	...
	add_action( 'manage_edit-contributor_sortable_columns', '\Pressbooks\Admin\Metaboxes\contributor_sortable_columns' );
	...
	add_action( 'terms_clauses', '\Pressbooks\Metadata\contributor_meta_custom_sort', 10, 3 );
