...
class PostTypeTest extends \WP_UnitTestCase
{
     ...
     * @group posttypes
     */
    public function test_list_post_types()
    {
        $v = list_post_types();
     ...
     * @group posttypes
     */
    public function test_disable_months_dropdown()
    {
     ...
     * @group posttypes
     */
    public function test_wp_editor_settings()
    {
        global $post;
     ...
     * @group posttypes
     */
    public function test_register_post_statii()
    {
     ...
     * @group posttypes
     */
    public function test_add_post_types_rss()
    {
        $args['feed'] = true;
     ...
     * @group posttypes
     */
    public function test_add_posttypes_to_hypothesis()
    {
     ...
     * @group posttypes
     */
    public function test_filter_post_type_label()
    {
