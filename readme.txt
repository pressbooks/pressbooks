...
* See: https://github.com/pressbooks/pressbooks/releases/tag/5.8.2
* Full release history available at: https://github.com/pressbooks/pressbooks/releases

== Upgrade Notice ==
= 5.8.2 =

* Pressbooks 5.8.2 requires PHP >= 7.1.
* Pressbooks 5.8.2 requires [WordPress 5.2.1](https://wordpress.org/news/2019/05/wordpress-5-2-1-maintenance-release/)
* Pressbooks 5.8.2 requires [McLuhan >= 2.8.7](https://github.com/pressbooks/pressbooks-book/)
