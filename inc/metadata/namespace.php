...
function register_contributor_meta() {
	register_meta( 'term', 'contributor_first_name', [ 'sanitize_callback' => 'sanitize_text_field' ] );
	register_meta( 'term', 'contributor_last_name', [ 'sanitize_callback' => 'sanitize_text_field' ] );
}
