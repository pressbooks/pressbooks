...
class Admin_CoverGeneratorTest extends \WP_UnitTestCase
{
     ...
     */
    public function test_display_generator()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_generator_css_js()
    {
     ...
     * @group covergenerator
     */
    public function test_cg_options_init()
    {
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_text_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_title_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_title_spine_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_subtitle_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_author_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_author_spine_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_about_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_isbn_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_sku_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_design_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_front_background_image_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_text_transform_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_spine_size_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_pdf_pagecount_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_ppi_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_custom_ppi_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_colors_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_color_callback()
    {
        ob_start();
     ...
     * @group covergenerator
     */
    public function test_pressbooks_cg_options_sanitize()
    {
