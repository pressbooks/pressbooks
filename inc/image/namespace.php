...
function default_cover_url( $size = 'full' ) {
	 ...
	 *
	 */
	return apply_filters( 'pb_default_cover_url', PB_PLUGIN_URL . "assets/dist/images/default-book-cover${suffix}.jpg" );
}
...
function default_cover_path( $size = 'full' ) {
	 ...
	 *
	 */
	return apply_filters( 'pb_default_cover_path', PB_PLUGIN_DIR . "assets/dist/images/default-book-cover${suffix}.jpg" );
}
