...
abstract class Export
{
     ...
     * @var bool
     */
    public static $switchedLocale;

    /**
     * @var array
     */
    public static $exportConversionError = [];

    /**
     * @var array
     */
    public static $exportValidationWarning = [];

    /**
     * @var []
     */
    public static $exportOutputs = [];
     ...
     * @return string
     */
    public function getExportStylePath($type)
    {
     ...
     * @return string
     */
    public function getLatestExportStylePath($type)
    {
     ...
     * @return string
     */
    public function getLatestExportStyleUrl($type)
    {
        // This method only supports Prince stylesheets at the moment.
        if (in_array($type, [ 'prince' ], true)) {
            foreach (scandir_by_date(Container::get('Sass')->pathToUserGeneratedCss()) as $file) {
     ...
     * @param int $max
     */
    public function truncateExportStylesheets($type, $max = 1)
    {
        // This method only supports Prince stylesheets at the moment.
        if (in_array($type, [ 'prince' ], true)) {
     ...
     * @return string
     */
    public function getExportScriptPath($type)
    {
     ...
     * @return string
     */
    public function getExportScriptUrl($type)
    {
     ...
     * @return bool
     */
    public function verifyNonce($timestamp, $md5)
    {
     ...
     * @return string
     */
    public function fixAnnoyingCharacters($html)
    {
