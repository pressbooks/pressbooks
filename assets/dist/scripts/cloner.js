...
jQuery(function ($) {
  ...
  clonerForm.on('submit', function (e) {
    ...
    var eventSourceUrl = PB_ClonerToken.ajaxUrl + (PB_ClonerToken.ajaxUrl.includes('?') ? '&' : '?') + $.param(clonerForm.find(':input'));
    ...
    evtSource.onopen = function () {
      // Start clock
      clock = (0,_utils_startClock__WEBPACK_IMPORTED_MODULE_2__["default"])(); // Warn the user if they navigate away
