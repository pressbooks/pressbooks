...
class Disable_Comments_MU {
	...
	function setup_filters(){
		...
		if( is_admin() ) {
			...
			add_action( 'admin_head', [$this, 'hide_dashboard_bits'] );
		...
		// Filters for front end only
			...
			add_action('wp_head', [$this, 'before_wp_head'], 0 );
		}
	}
	...
	function dummy_comments_template() {
		return __DIR__ . '/disable-comments-mu/comments-template.php';
	}
	...
	function hide_dashboard_bits(){
		if( 'dashboard' == get_current_screen()->id )
			add_action( 'admin_print_footer_scripts', [$this, 'dashboard_js'] );
	}
