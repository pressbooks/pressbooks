	...
	<div class="pb-dashboard-row">
		<div class="pb-dashboard-panel">
			<div class="pb-dashboard-content network-checklist">
				...
				<p>{{ __( 'You are ready to launch your Pressbooks network. We hope you\'re excited to start inviting users to begin creating and publishing books.' ) }}</p>
				<p>{{ __( 'You can help us understand and improve the network manager onboarding experience by completing a brief \'Readiness to Launch\' survey.', 'pressbooks' ) }}</p>
