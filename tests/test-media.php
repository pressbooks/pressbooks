...
class MediaTest extends \WP_UnitTestCase {
	...
	public function test_force_wrap_images() {
		...
		$case = '<p><a href="https://university.pressbooks.pub/app/uploads/sites/112/2018/12/image1-1.jpeg"><img class="aligncenter wp-image-33 size-thumbnail" src="https://university.pressbooks.pub/app/uploads/sites/112/2018/12/image1-1-150x150.jpeg" alt="Green cacti and a grey sky" width="150" height="150" /></a><br /></p>';
		$converted = \Pressbooks\Media\force_wrap_images( $case );
		$this->assertStringStartsWith( '<div class="wp-nocaption aligncenter wp-image-33 size-thumbnail"><a ', $converted );
		$this->assertStringEndsWith( '</a></div><p>', $converted );
	}
