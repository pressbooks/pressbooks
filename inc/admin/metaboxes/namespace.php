...
function metadata_subject_box( $post ) {
	...
	<div class="custom-metadata-field select">
		...
		<span class="description"><?php printf(
			__( 'This appears on the web homepage of your book and helps categorize it in your network catalog (if applicable). Use %s to determine which subject category is best for your book.', 'pressbooks' ),
			sprintf(
				'<a href="%1$s">%2$s</a>',
				'http://www.editeur.org/files/Thema/20160601%20Thema%20v1.2%20Basic%20instructions.pdf',
				__( 'these instructions', 'pressbooks' )
        )
		); ?></span>
	</div>
	<div class="custom-metadata-field select">
		...
		<span class="description"><?php printf(
			__( 'This appears on the web homepage of your book. Use %s to determine which additional subject categories are appropriate for your book.', 'pressbooks' ),
			sprintf(
				'<a href="%1$s">%2$s</a>',
				'http://www.editeur.org/files/Thema/20160601%20Thema%20v1.2%20Basic%20instructions.pdf',
				__( 'these instructions', 'pressbooks' )
