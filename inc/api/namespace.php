...
/**
 * Set up the REST API client JS.
 *
 * @since 5.0.0
 *
 * @see https://github.com/WP-API/client-js/blob/master/client-js.php
 */
function init_client_js() {
	// Load the schema.
	$wp_rest_server = new \WP_REST_Server();
	$schema_request  = new \WP_REST_Request( 'GET', '/pressbooks/v2' );
