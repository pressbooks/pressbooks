System.register(["./lit-element-legacy-DWFBGLyg.js"],function(e,t){"use strict";var s,i,o,n;return{setters:[e=>{s=e.E,i=e.r,o=e.i,n=e.x}],execute:function(){
/**
       * @license
       * Copyright 2018 Google LLC
       * SPDX-License-Identifier: BSD-3-Clause
       */
const e=e=>e??s;window.customElements.define("pressbooks-reorderable-multiselect",class extends i{static get styles(){return o`
      :host {
    ...
    `}static get properties(){return{messages:{type:Object},name:{type:String},label:{type:String},hint:{type:String},listBoxHasFocus:{type:Boolean},activeDescendant:{type:String},options:{type:Object},selectedOptions:{type:Object},availableOptions:{type:Object},selectedAvailableOption:{type:String},actionMessage:{type:String},ListboxActions:{type:Object},Keys:{type:Object}}}constructor(){super(),this.messages={},this.label="",this.hint="",this.listBoxHasFocus=!1,this.activeDescendant=null,this.options={},this.selectedOptions={},this.availableOptions={},this.selectedAvailableOption="",this.actionMessage=null,this.ListboxActions={MoveUp:"MoveUp",MoveDown:"MoveDown",MoveSelectionUp:"MoveSelectionUp",MoveSelectionDown:"MoveSelectionDown",Remove:"Remove"},this.Keys={Backspace:"Backspace",Clear:"Clear",Down:"ArrowDown",End:"End",Enter:"Enter",Escape:"Escape",Home:"Home",Left:"ArrowLeft",PageDown:"PageDown",PageUp:"PageUp",Right:"ArrowRight",Space:" ",Tab:"Tab",Up:"ArrowUp"}}labelTemplate(){return n`<label id="${this.name}-label">${this.label}</label>`}hintTemplate(){return n`<p id="${this.name}-hint" class="hint">${this.hint}</p>`}selectedOptionsTemplate(){return n` ${Object.keys(this.selectedOptions).map(e=>n`<input type="hidden" name="${this.name}[]" .value=${e} />`)}
      ...
      </ul>`}availableOptionsTemplate(){return n` <select
      ...
      >
        ${Object.entries(this.availableOptions).map(e=>Object.keys(this.selectedOptions).includes(e)?null:n`<option value="${e[0]}">${e[1]}</option>`)}
      </select>
      <button
        type="button"
        class="add"
      ...
      </button>`}selectedOptionsControlsTemplate(){return n`
