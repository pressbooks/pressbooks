...
class GoogleAnalytics {
	...
	public function __construct() {
		...
		$this->settings['input_legend'] = __( 'To send page traffic to Google Analytics (optional), provide your Google Analytics ID, e.g &lsquo;G-A123B4C5DE6&rsquo;.', 'pressbooks' );}
