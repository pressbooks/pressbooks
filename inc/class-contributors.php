...
class Contributors implements BackMatter, Transferable {
	 ...
	 * If the contributor's slug generated by name already exists it won't be created, but could be associated
	 * if $post_id is present ($post_id != 0).
	 *
	 ...
	 */
	public function insert( $data, $post_id = 0, $contributor_type = 'pb_authors', $downloads = null ) {
		if ( is_string( $data ) ) {
	...
	public function copyPictureFromExternalURLToLocalMedia( $external_url_image ) {
