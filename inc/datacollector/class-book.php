...
class Book
{
    ...
    public const THUMBNAIL = 'pb_thumbnail_image';
    ...
    public const LANGUAGE_NAME = 'pb_language_name';
    ...
    public const LICENSE_CODE = 'pb_license_code';

    public const LICENSE_NAME = 'pb_license_name';
    ...
    public const IS_BASED_ON = 'pb_is_based_on';
    ...
    public const AUTHORS = 'pb_authors';

    public const EDITORS = 'pb_editors';

    public const CONTRIBUTORS = 'pb_contributors';

    public const SHORT_DESCRIPTION = 'pb_about_50';

    public const LONG_DESCRIPTION = 'pb_about_unlimited';

    public const INSTITUTIONS = 'pb_institutions';

    public const PUBLISHER = 'pb_publisher';

    public const SUBJECTS_CODES = 'pb_subjects_code';

    /**
     * Thema subjects strings with main site language applied.
     */
    public const SUBJECTS_STRINGS = 'pb_subjects_string';
