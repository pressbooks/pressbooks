	...
	<div class="pb-dashboard-panel">
		...
		<form id="pb-cloner-form" action="" method="post">
			...
			<div class="pb-dashboard-row">
				<p><label class="pb-label" for="source_book_url">{{ __( 'Source Book URL', 'pressbooks' ) }}</label></p>
			...
			<div class="pb-dashboard-row">
				...
				@if( is_subdomain_install() )
					<span><input class="regular-text code" id="target_book_url" name="target_book_url" type="text" required/>.{{ $domain }}</span>
				@else
