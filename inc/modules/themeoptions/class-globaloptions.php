...
class GlobalOptions extends \Pressbooks\Options {
	...
	function init() {
		...
		if ( Container::get( 'CustomStyles' )->isCurrentThemeCompatible( 1 ) === true || Container::get( 'CustomStyles' )->isCurrentThemeCompatible( 2 ) === true ) { // we can only enable foreign language typography for themes that use SCSS
