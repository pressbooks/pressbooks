	...
	*/
	...
	function renderPageWidthField( $args ) {
		$this->renderField( [
			...
			'value' => @$this->options['pdf_page_width'], // @codingStandardsIgnoreLine
			'description' => $args[0],
			'type' => 'text',
			'class' => 'small-text',
		] );
	...
	function renderPageHeightField( $args ) {
		$this->renderField( [
			...
			'value' => @$this->options['pdf_page_height'], // @codingStandardsIgnoreLine
			'description' => $args[0],
			'type' => 'text',
			'class' => 'small-text',
		] );
	...
	?>
		<?php $this->renderField( [
			...
			'value' => @$this->options['pdf_page_margin_outside'], // @codingStandardsIgnoreLine
			'description' => $args[0],
			'type' => 'text',
			'class' => 'small-text',
		] );
	...
	function renderInsideMarginField( $args ) {
		$this->renderField( [
			...
			'value' => @$this->options['pdf_page_margin_inside'], // @codingStandardsIgnoreLine
			'description' => $args[0],
			'type' => 'text',
			'class' => 'small-text',
		] );
	...
	function renderTopMarginField( $args ) {
		$this->renderField( [
			...
			'value' => @$this->options['pdf_page_margin_top'], // @codingStandardsIgnoreLine
			'description' => $args[0],
			'type' => 'text',
			'class' => 'small-text',
		] );
	...
	function renderBottomMarginField( $args ) {
		$this->renderField( [
			...
			'value' => @$this->options['pdf_page_margin_bottom'], // @codingStandardsIgnoreLine
			'description' => $args[0],
			'type' => 'text',
			'class' => 'small-text',
		] );
	...
	function renderHyphenationField( $args ) {
		$this->renderCheckbox( [
			...
			'name' => 'pressbooks_theme_options_' . $this->getSlug(),
			'option' => 'pdf_hyphens',
			'value' => @$this->options['pdf_hyphens'], // @codingStandardsIgnoreLine
			'label' => $args[0],
		] );
	}
	...
	function renderParagraphSeparationField( $args ) {
		$this->renderRadioButtons( [
			...
			'value' => @$this->options['pdf_paragraph_separation'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
	}
	...
	function renderSectionOpeningsField( $args ) {
		$this->renderRadioButtons( [
			...
			'value' => @$this->options['pdf_sectionopenings'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
	}
	...
	function renderTOCField( $args ) {
		$this->renderCheckbox( [
			...
			'name' => 'pressbooks_theme_options_' . $this->getSlug(),
			'option' => 'pdf_toc',
			'value' => @$this->options['pdf_toc'], // @codingStandardsIgnoreLine
			'label' => $args[0],
		] );
	}
	...
	function renderImageResolutionField( $args ) {
		$this->renderRadioButtons( [
			...
			'value' => @$this->options['pdf_image_resolution'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
	}
	...
	function renderCropMarksField( $args ) {
		$this->renderCheckbox( [
			...
			'value' => @$this->options['pdf_crop_marks'], // @codingStandardsIgnoreLine
			'label' => $args[0],
		] );
	}
	...
	function renderRomanizePartsField( $args ) {
		$this->renderCheckbox( [
			...
			'value' => @$this->options['pdf_romanize_parts'], // @codingStandardsIgnoreLine
			'label' => $args[0],
		] );
	}
	...
	function renderFootnoteStyleField( $args ) {
		$this->renderRadioButtons( [
			...
			'value' => @$this->options['pdf_footnotes_style'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
	}
	...
	function renderWidowsField( $args ) {
		$this->renderField( [
			...
			'name' => 'pressbooks_theme_options_' . $this->getSlug(),
			'option' => 'widows',
			'value' => @$this->options['widows'], // @codingStandardsIgnoreLine
			'type' => 'text',
			'class' => 'small-text',
		] );
	}
	...
	function renderOrphansField( $args ) {
		$this->renderField( [
			...
			'name' => 'pressbooks_theme_options_' . $this->getSlug(),
			'option' => 'orphans',
			'value' => @$this->options['orphans'], // @codingStandardsIgnoreLine
			'type' => 'text',
			'class' => 'small-text',
		] );
	}
	...
	function renderRunningContentFrontMatterLeftField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_front_matter_left'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_front_matter_left',
	...
	function renderRunningContentFrontMatterRightField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_front_matter_right'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_front_matter_right',
	...
	function renderRunningContentIntroductionLeftField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_introduction_left'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_introduction_left',
	...
	function renderRunningContentIntroductionRightField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_introduction_right'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_introduction_right',
	...
	function renderRunningContentPartLeftField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_part_left'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_part_left',
	...
	function renderRunningContentPartRightField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_part_right'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_part_right',
	...
	function renderRunningContentChapterLeftField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_chapter_left'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_chapter_left',
	...
	function renderRunningContentChapterRightField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_chapter_right'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_chapter_right',
	...
	function renderRunningContentBackMatterLeftField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_back_matter_left'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_back_matter_left',
	...
	function renderRunningContentBackMatterRightField( $args ) {
		$this->renderCustomSelect( [
			...
			'value' => @$this->options['running_content_back_matter_right'], // @codingStandardsIgnoreLine
			'choices' => $args,
		] );
		$this->renderField( [
			'id' => 'running_content_back_matter_right',
	...
	function renderFontSizeField( $args ) {
		$this->renderCheckbox( [
			...
			'name' => 'pressbooks_theme_options_' . $this->getSlug(),
			'option' => 'pdf_fontsize',
			'value' => @$this->options['pdf_fontsize'], // @codingStandardsIgnoreLine
			'label' => $args[0],
		] );
	}
	...
	static function getDefaults() {
		 ...
		 * @since 3.9.7 TODO
		 */
		return apply_filters( 'pb_theme_options_pdf_defaults', [
	...
	static function getBooleanOptions() {
		 ...
		 * @since 3.9.7
		 */
		return apply_filters( 'pb_theme_options_pdf_booleans', [
			'pdf_hyphens',
			'pdf_toc',
			'pdf_crop_marks',
			'pdf_romanize_parts',
	...
	static function getStringOptions() {
		 ...
		 * @since 3.9.7
		 */
		return apply_filters( 'pb_theme_options_pdf_strings', [
			'pdf_page_width',
			'pdf_page_height',
			'pdf_page_margin_outside',
			'pdf_page_margin_inside',
	...
	static function getIntegerOptions() {
		 ...
		 * @since 3.9.7
		 */
		return apply_filters( 'pb_theme_options_pdf_integers', [
			'pdf_body_font_size',
			'widows',
			'orphans',
		] );
	...
	static function getFloatOptions() {
		 ...
		 * @since 3.9.7
		 */
		return apply_filters( 'pb_theme_options_pdf_floats', [
			'pdf_body_line_height'
		] );
	}
	...
	static function getPredefinedOptions() {
		 ...
		 * @since 3.9.7
		 */
		return apply_filters( 'pb_theme_options_pdf_predefined', [
			'pdf_paragraph_separation',
			'pdf_sectionopenings',
			'pdf_image_resolution',
			'pdf_footnotes_style',
